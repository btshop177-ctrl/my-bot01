...
ADMIN_ID = int(_env("ADMIN_ID", "OWNER_ID", default="0"))

if not ADMIN_ID:
    raise SystemExit("❌ متغیر ADMIN_ID را در env تنظیم کنید")
if not BOT_TOKEN:
    raise SystemExit("❌ متغیر BOT_TOKEN را در env تنظیم کنید")
