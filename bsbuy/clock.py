...
api_id = os.getenv("API_ID")  # جایگزین کنید
api_hash = os.getenv("API_HASH")  # جایگزین کنید
phone_number = os.getenv("PHONE_NUMBER")
# ---------------------------------------------

app = Client("clock_session", api_id=api_id, api_hash=api_hash, phone_number=phone_number)
